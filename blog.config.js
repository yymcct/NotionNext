...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '02ab3b8678004aa69e9e415905ef32a5,en:2e2b75338c5281f0ab3fd3b1adb15ff2',
  THEME: process.env.NEXT_PUBLIC_THEME || 'my', // 当前主题，在themes文件夹下可找到所有支持的主题；主题名称就是文件夹名，例如 example,fukasawa,gitbook,heo,hexo,landing,matery,medium,next,nobelium,plog,simple
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'CodeWeng', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '全栈开发者，机器人开发探索者', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.codeweng.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '全栈, 开发者，机器人,ROS, 博客', // 网站关键词 英文逗号隔开
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || '/favicon.ico', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '豫ICP备2025125654号-1', // 备案号 闽ICP备XXXXXX
